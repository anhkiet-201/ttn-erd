                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <a 
                      ...
                      className="flex items-center gap-1.5 px-2 py-1 bg-green-500 text-white rounded-md text-[11px] font-bold hover:bg-green-600 transition-colors shadow-sm shadow-green-100 active:scale-95 duration-100"
                      title="Nhấn để gọi - Đã tích hợp tự động copy"
                    >
