                  ...
                  <tr key={item.id} className="hover:bg-gray-50/50 transition-all duration-300 group">
                    <td className="px-6 py-5">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <div className="font-black text-gray-900 leading-tight mb-0.5 group-hover:text-blue-600 transition-colors uppercase tracking-tight">{item.tenNguoiLaoDong}</div>
                    ...
                    <td className="px-6 py-5">
                        <div className="flex items-center gap-2">
                             ...
                             <span className="text-xs font-black text-gray-500 tracking-wider font-mono uppercase">{item.cccd || 'TRỐNG'}</span>
                        </div>
                    </td>
